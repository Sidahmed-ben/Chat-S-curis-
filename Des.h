...
static unsigned char tableau_key[16][48];

static int permutation_table[64] = {
    58, 50, 42, 34, 26, 18, 10, 2, 60, 52, 44, 36, 28, 20, 12, 4,
    62, 54, 46, 38, 30, 22, 14, 6, 64, 56, 48, 40, 32, 24, 16, 8,
    57, 49, 41, 33, 25, 17, 9,  1, 59, 51, 43, 35, 27, 19, 11, 3,
    61, 53, 45, 37, 29, 21, 13, 5, 63, 55, 47, 39, 31, 23, 15, 7};

static int inv_permutation_table[64] = {
    40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31,
    38, 6, 46, 14, 54, 22, 62, 30, 37, 5, 45, 13, 53, 21, 61, 29,
    36, 4, 44, 12, 52, 20, 60, 28, 35, 3, 43, 11, 51, 19, 59, 27,
    34, 2, 42, 10, 50, 18, 58, 26, 33, 1, 41, 9,  49, 17, 57, 25};

static int bit32_to_48[] = {32, 1,  2,  3,  4,  5,  4,  5,  6,  7,  8,  9,
...
static int per_sec[32] = {16, 7, 20, 21, 29, 12, 28, 17, 1,  15, 23,
                          26, 5, 18, 31, 10, 2,  8,  24, 14, 32, 27,
                          3,  9, 19, 13, 30, 6,  22, 11, 4,  25};

static int keyp1[56] = {57, 49, 41, 33, 25, 17, 9,  1,  58, 50, 42, 34, 26, 18,
                        10, 2,  59, 51, 43, 35, 27, 19, 11, 3,  60, 52, 44, 36,
                        63, 55, 47, 39, 31, 23, 15, 7,  62, 54, 46, 38, 30, 22,
                        14, 6,  61, 53, 45, 37, 29, 21, 13, 5,  28, 20, 12, 4};

static int keyp2[48] = {14, 17, 11, 24, 1,  5,  3,  28, 15, 6,  21, 10,
...
void substitution_sbox(unsigned char *bloc_64x6,
                                 unsigned char *bloc_64x4);
void convert_48x8_64x6(unsigned char *chaine_48x8,
                                 unsigned char *bloc_64x6);
...
void permutation_initiale(unsigned char text_claire[9],
                                    unsigned char *permutation_text_claire,
                                    int taille);
void inverse_permutation(unsigned char *text_claire,
                                   unsigned char *permutation_text_claire,
                                   int taille);
void conv_64x4_to_32x4(unsigned char *bloc_64x4,
                                 unsigned char *bloc_32_4);
void permutation_secondaire(unsigned char *bloc_32x4,
                                      unsigned char *permutation_bloc_32x4);
void bloc32x8_xor_bloc32x8(unsigned char *result,
                                     unsigned char *left_bloc_32x8,
...
void key_64x8_to_56x8(unsigned char *key_64x8,
                                unsigned char *key_56x8);
