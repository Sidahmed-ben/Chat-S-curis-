...
void permutation_initiale(unsigned char text_claire[9],unsigned char * permutation_text_claire, int taille) { 
  unsigned char permutation_bloc ={0}  ;
  unsigned char permutation_bloc_tmp ={0}  ;
  int  ind_tc = 0;
  int  ind_shift = 0;  
...
void inverse_permutation(unsigned char *text_claire,unsigned char * permutation_text_claire, int taille) { 
  unsigned char permutation_bloc ={0}  ;
  unsigned char permutation_bloc_tmp ={0}  ;
  int  ind_tc = 0;
  int  ind_shift = 0;  
...
void permutation_secondaire(unsigned char * bloc_32x4,unsigned char * permutation_bloc_32x4) { 
...
void  bloc32x8_xor_bloc32x8( unsigned char * result,unsigned char * left_bloc_32x8 , unsigned char * bloc_f_32x8)
{
  for(int i = 0 ; i< 4 ; i++){
...
unsigned char * des_encrypte(unsigned char * message , unsigned char * cle){
  ...
  // printf("perm_txt_cl[i] ");
  // for(int i = 0 ; i< 8 ; i++)
  //   printf("%c",perm_txt_cl[i]);
  // printf("\n");
...
unsigned char * des_decrypte(unsigned char * message , unsigned char * cle){
  ...
  /* Faire la permutation initialle */permutation_initiale(message, perm_txt_en, 8);
...
void message_org(unsigned char * message ,int taille, unsigned char * message_orga){
